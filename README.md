...
> This branch (`1.21.1`) targets **Minecraft 1.21.1 (Fabric + NeoForge)**. The Minecraft 1.20.1 flavors (Forge + Fabric) live on the `1.20.1` branch.
...
- **Exposure** ≥ 1.9.18 (Minecraft 1.21.1, Fabric & NeoForge 21.1+)
- Client side only.
...
# or: ./gradlew :fabric:build :neoforge:build
```
...
Exposure is resolved from CurseForge Maven (`curse.maven:exposure-871755:*`,
Fabric file 8223556 / NeoForge file 8223555 — both Exposure 1.9.18 for 1.21.1),
same as cfx-compat-epicfight does for Epic Fight.
